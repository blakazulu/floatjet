...
**Fonts:** Self-hosted via @fontsource. Bricolage Grotesque for headings, Figtree for body text, Caveat for handwritten notes, JetBrains Mono for code. Loaded from
...
to look professional on video calls while my neighbor mows his lawn. then I tell you what works.
