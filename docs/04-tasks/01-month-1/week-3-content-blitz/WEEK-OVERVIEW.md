# Week 3 Overview: Content Blitz

**Dates:** November 27 - December 3, 2025
**Sprint Goal:** Publish 3 money pages targeting high-value affiliate programs
...
- [ ] 3 money pages published
- [ ] Amazon Associates approved
- [ ] ConvertKit affiliate approved
- [ ] All articles internally linked
...
- **Money Pages:** Total 5/10 complete after this week
- **Word Count:** ~9,000-12,000 words total this week
- **Internal Links:** 3-5 per new article
...
```
FJ-012 (Laptops) ←→ FJ-007 (VPNs) - "secure your laptop while traveling"
FJ-012 (Laptops) ←→ FJ-006 (PM Software) - "best tools to run on your new laptop"
FJ-013 (Email) ←→ FJ-006 (PM Software) - "organize your creator workflow"
FJ-014 (Desks) ←→ FJ-012 (Laptops) - "complete home office setup"
```
...
- Content Templates: `/docs/02-content/content-guidelines.md`
- Affiliate Programs: `/docs/02-content/affiliate-programs.md`
- Task Details: Individual task files in this folder
...
**Next Step:** Apply to Amazon Associates and ConvertKit
