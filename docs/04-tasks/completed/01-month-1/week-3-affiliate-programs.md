...
> **NOTE:** This guide has been consolidated into the master affiliate programs document.
> See: `/docs/04-tasks/affiliate-programs.md` for the complete guide with step-by-step registration instructions.
...
**Note:** NordPass is bundled with NordVPN affiliate program. Once approved, you get affiliate links for both products
...
**Next Step:** Apply to Amazon Associates and ConvertKit immediately (24-48 hour approval time). NordPass already
applied via NordVPN program.
