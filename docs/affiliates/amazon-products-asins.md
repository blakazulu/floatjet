...
| Product                           | ASIN       | Price Range | Link Format                       |
|-----------------------------------|------------|-------------|-----------------------------------|
| **Logitech C920S HD Pro**         | B07K986YLL | ~$69        | `/go/amazon/logitech-c920s`       |
| **Logitech Brio 4K**              | B01N5UOYC4 | ~$199       | `/go/amazon/logitech-brio-4k`     |
| **Logitech Brio 4K (2023 Model)** | B09NBWWP79 | ~$199       | `/go/amazon/logitech-brio-4k-new` |
| **Logitech MX Brio**              | B0BFJ4CRKD | ~$199       | `/go/amazon/logitech-mx-brio`     |
| **Anker PowerConf C300**          | B08RNHCZ3K | ~$89        | `/go/amazon/anker-powerconf-c300` |
...
| Product                             | ASIN       | Price Range | Link Format                        |
|-------------------------------------|------------|-------------|------------------------------------|
| **Sony WH-1000XM5 (Black)**         | B09XS7JWHH | ~$399       | `/go/amazon/sony-wh1000xm5-black`  |
| **Sony WH-1000XM5 (Silver)**        | B09XSDMT4F | ~$399       | `/go/amazon/sony-wh1000xm5-silver` |
| **Sony WH-1000XM5 (Midnight Blue)** | B0BXYCS74H | ~$399       | `/go/amazon/sony-wh1000xm5-blue`   |
...
| Product                              | ASIN       | Price Range | Link Format                      |
|--------------------------------------|------------|-------------|----------------------------------|
| **Keychron K2 (Gateron Red, RGB)**   | B07Y9Y69N7 | ~$89        | `/go/amazon/keychron-k2-red`     |
| **Keychron K2 (Gateron Brown, RGB)** | B07QCP491R | ~$89        | `/go/amazon/keychron-k2-brown`   |
| **Keychron K2 (Hot-swappable)**      | B08742M6VW | ~$99        | `/go/amazon/keychron-k2-hotswap` |
...
```
https://amazon.com/dp/B0CX22ZW1T?tag=floatjet-20
```
...
to = "https://amazon.com/dp/B0CX22ZW1T?tag=floatjet-20"
status = 301
force = true
```
...
## Products Still Needed (No ASIN Yet)

These products are mentioned in articles but need ASINs to be found manually:
...
1. **Use provided ASINs** - Start with products above
2. **Find remaining ASINs** - Search Amazon for products in "Still Needed" section
3. **Update netlify.toml** - Add redirects (see next file)
4. **Test links** - Verify all redirects work with tag=floatjet-20

---

**Sources for ASIN Research:**

- [Amazon MacBook Air M3](https://www.amazon.com/Apple-2024-MacBook-13-inch-Laptop/dp/B0CX22ZW1T)
- [Amazon Dell XPS 13](https://www.amazon.com/Dell-Touchscreen-Elite-X1E-80-100-Fingerprint/dp/B0DJPYW835)
- [Amazon FlexiSpot E7](https://www.amazon.com/FlexiSpot-Electric-Standing-Adjustable-Computer/dp/B08B3X9CKH)
- [Amazon Logitech C920S](https://www.amazon.com/Logitech-C920S-Pro-HD-Webcam/dp/B07K986YLL)
- [Amazon Sony WH-1000XM5](https://www.amazon.com/Sony-WH-1000XM5-Canceling-Headphones-Hands-Free/dp/B09XS7JWHH)
- [Amazon Herman Miller Aeron](https://www.amazon.com/Herman-Miller-Aeron-Chair-Graphite/dp/B01N0ZUN15)
- [Amazon Keychron K2](https://www.amazon.com/Keychron-Wireless-Bluetooth-Mechanical-Keyboard/dp/B07Y9Y69N7)
