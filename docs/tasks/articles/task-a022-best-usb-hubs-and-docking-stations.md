---
task_id: "FJ-A022"
title: "Write Article: Best USB Hubs and Docking Stations"
category: "Content"
priority: "P2"
status: "not-started"
...
# Task: Write Article - Best USB Hubs and Docking Stations

## Overview

Write a money page article about Anker, CalDigit, Twelve South comparison for the Gear section (accessories subcategory).

**Article Type:** Money Page
**Section:** Gear
**Category:** Accessories
**Assigned Writer:** marcus-chen
**Target Slug:** `best-usb-hubs-and-docking-stations`
...
- [ ] Write compelling money page that ranks for "best usb hubs and docking stations" keywords
...
- [ ] 4.1 Create article page
    ...
    - `src/pages/gear/best-usb-hubs-and-docking-stations.astro`
...
| CalDigit | Not Applied | Direct | - |

**Notes:** Use Amazon Associates for Anker products. Research CalDigit direct program.
...
- **Description:** Anker, CalDigit, Twelve South comparison
