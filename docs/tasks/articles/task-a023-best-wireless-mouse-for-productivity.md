---
task_id: "FJ-A023"
title: "Write Article: Best Wireless Mouse for Productivity"
category: "Content"
priority: "P2"
status: "not-started"
...
tags: ["gear", "accessories", "money-page"]
---

# Task: Write Article - Best Wireless Mouse for Productivity

## Overview

Write a money page article about Logitech MX Master vs Razer vs Apple for the Gear section (accessories subcategory).

**Article Type:** Money Page
**Section:** Gear
**Category:** Accessories
**Assigned Writer:** marcus-chen
**Target Slug:** `best-wireless-mouse-for-productivity`
...
- [ ] Write compelling money page that ranks for "best wireless mouse for productivity" keywords
...
- [ ] 4.1 Create article page
    ...
    - `src/pages/gear/best-wireless-mouse-for-productivity.astro`
...
| Logitech | Not Applied | Direct | 4-6% |

**Notes:** Use Amazon Associates. Apply to Logitech direct program for MX Master.
...
- **Description:** Logitech MX Master vs Razer vs Apple
