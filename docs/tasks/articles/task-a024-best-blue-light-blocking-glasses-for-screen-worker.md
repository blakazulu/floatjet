---
task_id: "FJ-A024"
title: "Write Article: Best Blue Light Blocking Glasses for Screen Workers"
category: "Content"
priority: "P2"
status: "not-started"
...
# Task: Write Article - Best Blue Light Blocking Glasses for Screen Workers

## Overview

Write a money page article about Felix Gray, Zenni, GUNNAR for the Gear section (accessories subcategory).

**Article Type:** Money Page
**Section:** Gear
**Category:** Accessories
**Assigned Writer:** marcus-chen
**Target Slug:** `best-blue-light-blocking-glasses-for-screen-workers`
...
- [ ] Write compelling money page that ranks for "best blue light blocking glasses for screen workers" keywords
...
- [ ] 4.1 Create article page
    ...
    - `src/pages/gear/best-blue-light-blocking-glasses-for-screen-workers.astro`
...
- **Description:** Felix Gray, Zenni, GUNNAR
