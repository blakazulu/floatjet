---
task_id: "FJ-A025"
title: "Write Article: How to Give Feedback Remotely Without Sounding Harsh"
category: "Content"
priority: "P2"
status: "not-started"
...
tags: ["guides", "communication", "supporting-content"]
---

# Task: Write Article - How to Give Feedback Remotely Without Sounding Harsh

## Overview

Write a supporting content article about constructive feedback techniques for the Guides section (communication subcategory).

**Article Type:** Supporting Content
**Section:** Guides
**Category:** Communication
**Assigned Writer:** sarah-mitchell
**Target Slug:** `how-to-give-feedback-remotely-without-sounding-harsh`
...
- [ ] Write compelling supporting content that ranks for "how to give feedback remotely without sounding harsh" keywords
...
- [ ] 4.1 Create article page
    ...
    - `src/pages/guides/how-to-give-feedback-remotely-without-sounding-harsh.astro`
...
**Notes:** Educational content. Link to communication tools articles for affiliate opportunities.
