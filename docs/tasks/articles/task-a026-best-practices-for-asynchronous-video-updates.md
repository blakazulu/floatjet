---
task_id: "FJ-A026"
title: "Write Article: Best Practices for Asynchronous Video Updates"
category: "Content"
priority: "P2"
status: "not-started"
...
tags: ["guides", "communication", "money-page"]
---

# Task: Write Article - Best Practices for Asynchronous Video Updates

## Overview

Write a money page article about Loom-style communication guide for the Guides section (communication subcategory).

**Article Type:** Money Page
**Section:** Guides
**Category:** Communication
**Assigned Writer:** sarah-mitchell
**Target Slug:** `best-practices-for-asynchronous-video-updates`
...
- [ ] Write compelling money page that ranks for "best practices for asynchronous video updates" keywords
...
- [ ] 4.1 Create article page
    ...
    - `src/pages/guides/best-practices-for-asynchronous-video-updates.astro`
...
- **Description:** Loom-style communication guide
