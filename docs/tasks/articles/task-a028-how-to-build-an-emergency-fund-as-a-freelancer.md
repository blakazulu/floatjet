---
task_id: "FJ-A028"
title: "Write Article: How to Build an Emergency Fund as a Freelancer"
category: "Content"
priority: "P2"
status: "not-started"
...
tags: ["guides", "finance", "supporting-content"]
---

# Task: Write Article - How to Build an Emergency Fund as a Freelancer

## Overview

Write a supporting content article about 6-12 month runway planning for the Guides section (finance subcategory).

**Article Type:** Supporting Content
**Section:** Guides
**Category:** Finance
**Assigned Writer:** daniel-brooks
**Target Slug:** `how-to-build-an-emergency-fund-as-a-freelancer`
...
- [ ] Write compelling supporting content that ranks for "how to build an emergency fund as a freelancer" keywords
...
- [ ] 4.1 Create article page
    ...
    - `src/pages/guides/how-to-build-an-emergency-fund-as-a-freelancer.astro`
...
|---------|--------|---------|------------|
| Wise | Not Applied | Direct | £15-50/referral |
| Betterment | Not Applied | Direct | $50-75/signup |

**Notes:** Link to banking and budgeting articles. Apply to Wise and Betterment.
...
- **Description:** 6-12 month runway planning
