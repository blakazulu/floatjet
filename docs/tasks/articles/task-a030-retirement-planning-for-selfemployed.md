---
task_id: "FJ-A030"
title: "Write Article: Retirement Planning for Self-Employed"
category: "Content"
priority: "P2"
status: "not-started"
...
tags: ["guides", "finance", "seo-traffic-builder"]
---

# Task: Write Article - Retirement Planning for Self-Employed

## Overview

Write a seo traffic builder article about SEP IRA vs Solo 401k vs Simple IRA for the Guides section (finance subcategory).

**Article Type:** SEO Traffic Builder
**Section:** Guides
**Category:** Finance
**Assigned Writer:** daniel-brooks
**Target Slug:** `retirement-planning-for-selfemployed`
...
- [ ] Write compelling seo traffic builder that ranks for "retirement planning for self-employed" keywords
...
- [ ] 4.1 Create article page
    ...
    - `src/pages/guides/retirement-planning-for-selfemployed.astro`
...
| Acorns | Not Applied | Direct | - |

**Notes:** Apply to Betterment and Wealthfront direct programs. Good commission rates.
...
- **Description:** SEP IRA vs Solo 401k vs Simple IRA
