---
task_id: "FJ-A032"
title: "Write Article: How to Create a Weekly Review System That Actually Works"
category: "Content"
priority: "P2"
status: "not-started"
...
tags: ["guides", "productivity", "supporting-content"]
---

# Task: Write Article - How to Create a Weekly Review System That Actually Works

## Overview

Write a supporting content article about GTD-style reviews for the Guides section (productivity subcategory).

**Article Type:** Supporting Content
**Section:** Guides
**Category:** Productivity
**Assigned Writer:** sarah-mitchell
**Target Slug:** `how-to-create-a-weekly-review-system-that-actually-works`
...
- [ ] Write compelling supporting content that ranks for "how to create a weekly review system that actually works" keywords
...
- [ ] 4.1 Create article page
    ...
    - `src/pages/guides/how-to-create-a-weekly-review-system-that-actually-works.astro`
...
|---------|--------|---------|------------|
| Notion | Deferred | Impact Radius | $100-500/sale |

**Notes:** Link to note-taking and productivity tools articles.
