---
task_id: "FJ-A034"
title: "Write Article: How to Spot a Job Scam When Applying for Remote Work"
category: "Content"
priority: "P2"
status: "not-started"
...
tags: ["guides", "security", "supporting-content"]
---

# Task: Write Article - How to Spot a Job Scam When Applying for Remote Work

## Overview

Write a supporting content article about red flags and verification for the Guides section (security subcategory).

**Article Type:** Supporting Content
**Section:** Guides
**Category:** Security
**Assigned Writer:** daniel-brooks
**Target Slug:** `how-to-spot-a-job-scam-when-applying-for-remote-work`
...
- [ ] Write compelling supporting content that ranks for "how to spot a job scam when applying for remote work" keywords
...
- [ ] 4.1 Create article page
    ...
    - `src/pages/guides/how-to-spot-a-job-scam-when-applying-for-remote-work.astro`
...
**Notes:** Educational content. Link to security tools articles.
...
- **Description:** red flags and verification
