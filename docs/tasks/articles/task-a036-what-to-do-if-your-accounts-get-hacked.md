---
task_id: "FJ-A036"
title: "Write Article: What to Do If Your Accounts Get Hacked"
category: "Content"
priority: "P2"
status: "not-started"
...
tags: ["guides", "security", "seo-traffic-builder"]
---

# Task: Write Article - What to Do If Your Accounts Get Hacked

## Overview

Write a seo traffic builder article about recovery guide and prevention for the Guides section (security subcategory).

**Article Type:** SEO Traffic Builder
**Section:** Guides
**Category:** Security
**Assigned Writer:** daniel-brooks
**Target Slug:** `what-to-do-if-your-accounts-get-hacked`
...
- [ ] Write compelling seo traffic builder that ranks for "what to do if your accounts get hacked" keywords
...
- [ ] 4.1 Create article page
    ...
    - `src/pages/guides/what-to-do-if-your-accounts-get-hacked.astro`
...
**Notes:** Multiple approved programs! Include password manager and VPN CTAs.
...
- **Description:** recovery guide and prevention
