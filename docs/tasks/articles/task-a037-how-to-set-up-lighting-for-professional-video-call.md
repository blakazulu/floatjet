---
task_id: "FJ-A037"
title: "Write Article: How to Set Up Lighting for Professional Video Calls"
category: "Content"
priority: "P2"
status: "not-started"
...
tags: ["guides", "setup", "supporting-content"]
---

# Task: Write Article - How to Set Up Lighting for Professional Video Calls

## Overview

Write a supporting content article about ring lights and key lighting for the Guides section (setup subcategory).

**Article Type:** Supporting Content
**Section:** Guides
**Category:** Setup
**Assigned Writer:** sarah-mitchell
**Target Slug:** `how-to-set-up-lighting-for-professional-video-calls`
...
- [ ] Write compelling supporting content that ranks for "how to set up lighting for professional video calls" keywords
...
- [ ] 4.1 Create article page
    ...
    - `src/pages/guides/how-to-set-up-lighting-for-professional-video-calls.astro`
...
**Notes:** Use Amazon Associates. Apply to B&H Photo for higher-end products.
...
- **Description:** ring lights and key lighting
