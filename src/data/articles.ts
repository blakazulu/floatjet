...
export interface Article {
  ...
  featured?: boolean;
  /**
   * Date (YYYY-MM-DD) of the last substantive content review - prices, picks and facts re-checked.
   * Drives the "Updated" byline, Article dateModified and sitemap lastmod. Never bump it without a real review.
   */
  updatedDate?: string;
}
...
export const blogArticles: Article[] = [
  ...
  },
  {
    ...
    description: "Regular travel insurance wasn't built for people with no return ticket. SafetyWing, World Nomads, Genki and others compared with 2026 prices.",
    pubDate: "2025-05-13",
  ...
  },
  {
    ...
    section: "blog",
    title: "Crypto-Friendly Banks for Remote Workers (2026)",
    description: "Some banks used to freeze your account the moment they saw Coinbase. A lot changed in 2025. Here's what works in 2026, and what shut down.",
    pubDate: "2025-06-10",
    updatedDate: "2026-09-24",
    readingTime: 3,
...
export const gearArticles: Article[] = [
  ...
  },
  {
    ...
    section: "gear",
    title: "How Much RAM Do You Really Need for Remote Work? (2026)",
    description: "Is 8GB RAM enough for working from home in 2026? RAM needs for video calls, browser tabs and Office apps, plus why memory prices jumped and what that means when you buy.",
    pubDate: "2025-09-21",
    updatedDate: "2026-09-24",
    readingTime: 8,
...
export const guidesArticles: Article[] = [
  ...
  },
  {
    ...
    section: "guides",
    title: "Can You Write Off Home Office Equipment? (2026 Rules)",
    description: "Can you write off that standing desk? Yeah, if you meet the rules. What changed with the 2025 tax law, and what counts in 2026.",
    pubDate: "2025-11-28",
    updatedDate: "2026-09-24",
    readingTime: 7,
  ...
  },
  {
    ...
    section: "guides",
    title: "How to Expense Home Office Furniture: Complete Guide (2026)",
    description: "The rules for deducting home office furniture in 2026. Desks, chairs, lighting: what qualifies, what the 2025 tax law changed, and how to document it.",
    pubDate: "2025-08-10",
    updatedDate: "2026-09-24",
    readingTime: 9,
  ...
  },
  {
    ...
    section: "guides",
    title: "Invoice Payment Terms: Net 30 vs Net 15 (2026)",
...
export const toolsArticles: Article[] = [
  {
    ...
    section: "tools",
    title: "Accept International Payments Without Losing 5% (2026)",
    description: "The cheapest ways to get paid by international clients in 2026. Wise, Payoneer, PayPal and Stripe fees compared, with real numbers.",
    pubDate: "2025-01-09",
    updatedDate: "2026-09-24",
    readingTime: 12,
  ...
  },
  {
    ...
    description: "QuickBooks Solopreneur, FreshBooks, Wave, Xero and more for freelancers. 2026 prices, what shut down, and what works for different situations.",
    pubDate: "2025-07-29",
    updatedDate: "2026-09-24",
    readingTime: 18,
  ...
  },
  {
    ...
    section: "tools",
    title: "Best Business VPN Solutions for Remote Teams (2026)",
    description: "NordLayer for most companies, Twingate for zero-trust, Cloudflare free for small teams. 2026 prices, plus what happened to Perimeter 81 and AnyConnect.",
    pubDate: "2025-02-15",
    updatedDate: "2026-09-24",
    readingTime: 16,
  ...
  },
  {
    ...
    section: "tools",
    title: "Free VPN vs Paid VPN: What You Need to Know (2026)",
  ...
  },
  {
    ...
    section: "tools",
    title: "How to Set Up a VPN on All Your Devices (2026 Guide)",
  ...
  },
  {
    ...
    section: "tools",
    title: "VPN Kill Switch Explained: Why Remote Workers Need It (2026)",
    description: "Your VPN will drop eventually. The kill switch decides whether that moment exposes everything or nothing. How to turn it on per device, and where it falls short in 2026.",
    pubDate: "2025-08-08",
    updatedDate: "2026-09-24",
    readingTime: 10,
...
/**
 * Last modified date for an article: its review date if set, otherwise its publish date
 */
